    ...
    <ul id="" class="ui-sortable" rel="cosa">
        <? foreach ($this->models as $key => $value) { ?>
            <li rel="<?= $value['model_id']?>" class="ui-state-default modelList" onclick="">
                <a target="_blank" href="<?= WEB . 'gallery/model/' . $value['model_id'] . '-' . $value['name']; ?>"><img caption="<?= $value['caption_' . LANG]; ?>" src="<?= URL . UPLOAD . $value['img'] ?>"></a>
                ...
                <input class="btnSmall editImg" type="button" value="Composite" onclick="location.href = '<?=URL ?>/models/composite/<?= $value['model_id']; ?>'" >
